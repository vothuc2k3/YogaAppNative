...
public class CategoryDAO {
    ...
    public void addCategory(ClassCategoryModel category) {
        openWritableDb();
    ...
    public void updateCategory(ClassCategoryModel category) {
        openWritableDb();
        ContentValues values = new ContentValues();
        values.put(COLUMN_NAME, category.getName());
        values.put(COLUMN_DESCRIPTION, category.getDescription());
        db.update(TABLE_NAME, values, COLUMN_ID + "=?", new String[]{category.getId()});
        closeDb();
    }

    public void deleteCategory(String categoryId) {
        openWritableDb();
        db.delete(TABLE_NAME, COLUMN_ID + "=?", new String[]{categoryId});
        closeDb();
    }
