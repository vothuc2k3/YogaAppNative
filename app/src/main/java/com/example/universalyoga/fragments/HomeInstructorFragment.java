...
public class HomeInstructorFragment extends Fragment {
    ...
    private void loadData() {
        List<ClassModel> classList = classDAO.getClassesWithSessionsByInstructor(uid);
        ...
        if (classList.isEmpty()) {
            ...
            ClassExpandableListAdapter classExpandableListAdapter = new ClassExpandableListAdapter(
                    getContext(), classList, sessionMap, userDAO, userDAO.getUserByUid(uid).getRole(),
